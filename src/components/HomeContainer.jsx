  ...
  return (
    <section className='grid grid-cols-1 md:grid-cols-2 gap-2 w-full ' id='home'>
        ...
        <p className='text-base text-textColor text-center md:text-left md:w-[80%]'>
          Lorem ipsum dolor, sit amet consectetur adipisicing elit. Facere minima nesciunt provident
           illum impedit reprehenderit accusantium. Dicta, magnam voluptas ipsum non quidem debitis 
           odio dolores labore sed porro quos expedita!
        </p>
