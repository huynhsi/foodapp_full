...
const CreateContainer = () => {
  ...
  const [alearStatus,setAlearStatus ] = useState("danger");
  ...
  const uploadImage = (e) => {
    ...
    uploadTask.on('sate_changed', (snapshot) => {
      const uploadProgress = (snapshot.bytesTransferred / snapshot.totalBytes) * 100;
    }, (err) => {
      console.log(err);
      setFields(true);
      setMsg('Error while uploading : Try again ! ');
      setAlearStatus('danger')
      setTimeout(() => {
        setFields(false)
        setIsLoading(false)
      },4000 );
      ...
      >
        {
          fields && (
            <motion.p 
              ...
              animate={{opacity: 1}}
              exit={{opacity: 0}}
            className={`w-full p-2 rounded-lg text-center ${alearStatus === 'danger' 
        ...
        <div className='w-full py-2 border-b border-gray-300 flex
          ...
          <div className='group flex justify-center items-center flex-col border-2 border-dotted border-gray-300 
            w-full h-255 md:h-420 cursor-pointer rounded-lg'>
              {isLoading ? ( <Loader/> ) : ( <>
                {!imageAsset ? (<>
                    ...
                    justify-center gap-2'>
                      ...
                      />
                        ...
                        <> <div className='relative h-full'>
                            <img src={imageAsset} alt="uploadImage"  className='w-full f-full object-cover'/>
          ...
          <div className='flex items-center w-full'>
            <button type='button' className='ml-0 ml:ml-auto w-full md:w-auto
